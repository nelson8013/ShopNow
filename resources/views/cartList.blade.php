@extends("master")
    @section("content")
        <div class="custom-product" style="margin-bottom:100px">
            <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><h6>{{$item->name}}</h6></div>
                                <div clas`s="panel-body">
                                    ...
                                    <div style="margin-left: 220px; margin-top: -60px; margin-bottom: 5 px">
                ...
                <div class="col-sm-2">
                    <a href="/ordernow" class="btn btn-danger" style="margin-left: 0px; width: 50rem">Order Now</a>
                </div>
            </div>
        </div>
    @endsection
    ...
    {{-- <div class="col-sm-12" style="margin-left: 510px; mar">
